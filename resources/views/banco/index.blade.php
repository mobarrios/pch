...
@section('content')
        ...
        <table id="table" class="table table-hover">
            ...
            @foreach($datas as $data)
                <tr>
                    <td>{{$data->id}}</td>
                    <td>{{$data->nombre}}</td>                   
                    <td><a href="{{route('banco.sucursal.index',$data->id)}}" class="btn   btn-secondary">Sucursales</td> 
                    <td>
    ...
    <div class="card-footer bg-white">
            <a href="{{ route(config($confFile.'.routeCreate')) }}" class="btn btn-success ">Crear banco</a>
    </div>
@endsection